...
* `no_vagrant_interface` - Disable the vagrant management interface. Disabled by default. Use only in advanced scenarios where a vagrant management interface is not needed
